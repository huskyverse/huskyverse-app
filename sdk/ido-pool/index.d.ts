declare function _exports(provider: any, program: any, idoName: any): {
    ...
    exchangeRedeemableForUsdc: ({ usdcMint, huskyverseMint }: any, userPubKey: any, withdrawalAmount: any) => Promise<any>;
    ...
    withdrawFromEscrow: ({ usdcMint }: {
        usdcMint: any;
    }, userUsdc: any, userPublicKey: any, amount: any) => Promise<void>;
    accounts: {
